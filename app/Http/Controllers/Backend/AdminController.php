...
class AdminController extends Controller
{
    ...
    public function chartCircle($Order)
    {
        ...
        foreach ($Order as $item) {
            $Order_detail = Order_detail::where("order_id", $item->id)->get();
    ...
    public function dashboard()
    {
            ...
            $countOrder = Order::where('payment_status', 1)->count();
    ...
    public function dashboards(Request $request)
    {
        ...
        $Order = Order::where('payment_status', 1)->whereBetween('created_at', [$start_date_order, $end_date_order])->get();
