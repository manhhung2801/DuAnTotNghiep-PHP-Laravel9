...
@section('content')
            ...
            <div class="all_content-login my-5">
                <div class="login-block row px-4 pt-4 pb-5">
                    <div class="login-form-wrapper col-md-7 col-12">
                        <img src="https://shopdunk.com/images/uploaded/banner/TND_M402_010%201.jpeg" class="d-block w-100"
                            alt="img">
                    </div>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" type="email" name="email"
                                    value="{{ old('email') }}" maxlength="25" ng-model="user">
                                @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" id="password" ng-model="pass"
                                        name="password">
                                    <span class="input-group-text" id="check_password" style="cursor: pointer; "><i
                                            class="fa-light fa-unlock"></i></span>
                                </div>
                                @if ($errors->any())
                                    <span class="text-danger">
                                        @error('password')
                            ...
                            <div class="form-link">
                                <span>Bạn chưa có tài khoảng? <a class="text-decoration-none"
    ...
    <script>
        ...
        check_password.onclick = function() {
