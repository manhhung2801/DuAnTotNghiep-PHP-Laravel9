...
@section('title', 'Thêm mới loại bài viết')
    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Thêm mới loại bài viết</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mt-2 mb-0 text-uppercase float-start">Thêm mới loại bài viết</h6>
                <a href="{{ route("admin.post-category.index") }}" class="btn btn-primary float-end">Quay lại</a>
            </div>
            <div class="card-body">
                <form class="row g-3" action="{{ route("admin.post-category.store") }}" method="POST">
                    @csrf
                    <div class="col-md-12">
