            ...
            <div class="card-body">
                <form class="row g-3" action="{{ route('admin.post.update', $post->id) }}" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="category" class="form-select main-category" name="category_id">
                            ...
                            @foreach ($post_categories as $post_categories)
                                <option {{ $post->category_id == $post_categories->id ? 'selected' : '' }}
                                    value="{{ $post_categories->id }}">{{ $post_categories->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <img src="{{ asset('uploads/image_banner/' . $post->image_banner) }}"
                            alt="{{ $post->image_banner }}" width="50px">
                        <input type="hidden" value="{{ $post->image_banner }}" name="image_banner">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="input9" class="form-select" name="status">
                            <option {{ $post->status == 1 ? 'selected' : '' }} value="1">Hoạt động</option>
                            <option {{ $post->status == 0 ? 'selected' : '' }} value="0">Không hoạt động</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="input9" class="form-select" name="type">
                            <option {{ $post->type == 0 ? 'selected' : '' }} value="0">Bài Viết</option>
                            <option {{ $post->type == 1 ? 'selected' : '' }} value="1">Banner</option>
                        </select>
                    </div>
