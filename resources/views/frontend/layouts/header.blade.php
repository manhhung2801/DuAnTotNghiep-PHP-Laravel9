                                ...
                                <ul class="dropdown-menu rounded-0 p-0" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li>
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <a class="dropdown-item border border-top-1 border-bottom-1" href="{{route('logout')}}" onclick="event.preventDefault();
                                    ...
                                    <li><a class="dropdown-item border border-top-1 border-bottom-1" href="/order">Đơn hàng của tôi</a></li>
