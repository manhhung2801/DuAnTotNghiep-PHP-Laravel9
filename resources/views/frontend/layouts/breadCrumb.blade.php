    ...
    <div class="container">
        <ul class="breadcrumb">
            <li class="home">
                ...
                <a href="/product/" title="Tất cả sản phẩm"><span>Tất cả sản phẩm</span></a>
                ...
                @if (isset($subCategory))
                    <span class="mr_lr mx-2"><i class="fas fa-angle-right"></i></span>
                    <a href="/product/{{ $subCategory->category->slug }}/" title="{{ $subCategory->category->name }}">
                ...
                @if (isset($childCategory))
                    <span class="mr_lr mx-2"><i class="fas fa-angle-right"></i></span>
                    <a href="/product/{{ $childCategory->category->slug }}/"
                        title="{{ $childCategory->category->name }}">
                        <span>{{ $childCategory->category->name }}</span>
                    </a>
                    <span class="mr_lr mx-2"><i class="fas fa-angle-right"></i></span>
                    <a href="/product/{{ $childCategory->category->slug }}/{{ $childCategory->subCategory->slug }}/"
                        title="{{ $childCategory->subCategory->name }}">
                        <span>{{ $childCategory->subCategory->name }}</span>
                    </a>
                    <span class="mr_lr mx-2"><i class="fas fa-angle-right"></i></span>
                    <a href="/product/{{ $childCategory->category->slug }}/{{ $childCategory->subCategory->slug }}/{{ $childCategory->slug }}/"
