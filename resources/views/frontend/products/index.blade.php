...
@section('description', 'Mua ngay ' . ($category->name ?? ($subCategory->name ?? ($childCategory->name ??
    ($product->name ?? 'sản phẩm ')))) . ' với mức giá ưu đãi, bảo hành uy tín kèm nhiều chương trình khuyến mãi giảm giá
