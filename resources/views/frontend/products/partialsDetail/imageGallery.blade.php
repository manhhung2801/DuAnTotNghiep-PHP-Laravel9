<div class="picture p-3 rounded-1" style="background: #ebebefb3">
    <img src="{{ asset('uploads/products/' . $product->image) }}" class="w-100 d-block m-0" alt="ảnh iphone">
</div>
    ...
    <ul class="p-0 d-flex">
        ...
        @foreach($product_image_galleries as $item)
            <li class="w-25 list-group-item p-3 border border-dark-subtle rounded-2 me-1">
                <img src="{{ asset('uploads/gallery/' . $item->image) }}" class="w-100 d-block" alt="thums">
            </li>
        @endforeach
        {{-- <li class="w-25 list-group-item p-3 border border-dark-subtle rounded-2 me-1">
