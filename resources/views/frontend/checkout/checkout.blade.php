...
<body>
    <div class="container mt-5 wrapper-checkout-page">
        <div class="row ">
                        ...
                        <div class="input-group my-3">
                            ...
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false"><img
                                    src="https://img.icons8.com/?size=100&id=60257&format=png&color=000000"
            ...
            <div class="col-md-4 order-2 order-md-2 mb-3">
                ...
                <section class="mt-3">
                    ...
                    <div class="form-group rounded-1 border p-1  align-content-center">
                        <div class="custom-control custom-radio mt-2 ms-2">
                            <div class="radio-wrapper ">
                                <div class="mt-0">
                                    <div class="radio__input">
                                        <input type="radio" class="input-radio" name="flexRadioDefault"
                    ...
                    <div class="form-group rounded-1 border p-1 mt-2">
                        <div class="radio-wrapper  ">
                            <div class="custom-control custom-radio mt-2 ms-2 d-flex" data-bs-toggle="collapse"
                ...
                <div class="ws">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="product__image pb-2">
                                                    <div class="product-thumbnail ">
                                                        <div class="product-thumbnail__wrapper" data-tg-static="">
                                                            <img src="//bizweb.dktcdn.net/thumb/thumb/100/480/632/products/220908114903-iphone-14-pro-max-1-1-2bf608ee-efbc-4923-b0a0-d80712cecc68.jpg?v=1681686257597"
                                                                alt=""
                                                                class="product-thumbnail__image border rounded-1">
                                                        </div>
                                            ...
                                            <tr class="product">
                                                <td class="product__image pb-2">
                                                    <div class="product-thumbnail">
                                                        <div class="product-thumbnail__wrapper" data-tg-static="">
                                                            <img src="//bizweb.dktcdn.net/thumb/thumb/100/480/632/products/221020105441-1-minhtuanmobile-ip.jpg?v=1681771577447"
                                                                alt=""
                                                                class="product-thumbnail__image border rounded-1">
                                                        </div>
                                                        <span class="product-thumbnail__quantity">1</span>
                                        ...
                                        <div class="fieldset">
                                            <div class="field ">
                                                <div class="field__input-btn-wrapper d-flex">
                                                    ...
                                                    <button class="border rounded-1 p-2 col-md-3 mx-1 w-25"
                                                        type="button">
                                            ...
                                            <tr class="total-line payment-due">
                                                ...
                                                <td class="total-line__price">
                                                    <span class="payment-due__price"
                                                        data-bind="getTextTotalPrice()">50.320.000₫</span>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8 order-summary__nav field__input-btn-wrapper order-2 order-md-1 ">
                            <a href="#"
                                class="previous-link text-decoration-none w-100  d-flex justify-content-md-start justify-content-center ">
