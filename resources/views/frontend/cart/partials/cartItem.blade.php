...
{{-- <span data-url="{{ route('cart.destroy', $item->id) }}" class="btn-delete btn_delete_cart ms-2 my-3">Xóa</span>
</div>
</td>
...
<td class="text-center">
    <form method="post" data-url="{{ route('cart.update', $item->id) }}">
        ...
        <div class="input-group mb-3" style="width:150px;padding-top:30px">
            ...
            <input id="qtyProduct" type="number" class="qtyProduct form-control text-center" maxlength="100"
                value="{{ $item->quantity }}">
                ...
                <div class="card rounded-3 mb-4 shadow-lg bg-body-tertiary border border-1">
                    <div class="card-body p-3">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div id="priceItem_cart"
                                class="col-8 col-md-2 col-lg-1 col-xl-2 offset-lg-1 px-3">
