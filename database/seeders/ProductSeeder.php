        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            DB::table('products')->insert([
                [
                    ...
                    'product_type' => 'new',
                    'seo_title' => '',
                    'promotion' => 'Thiết kế iPad Air 5 vuông vức như cũ, thêm 2 màu sắc mới cá tínhNhìn chung, thiết kế của iPad Air 5 ',
                    'seo_description' => '',
                    'category_id' => 1,
                    'weight' => 0.5,
                    'sub_category_id' => 1,
            ...
            DB::table('products')->insert([
                [
                    ...
                    'product_type' => 'new',
                    'seo_title' => 'SEO tile',
                    'promotion' => 'MacBook Air 13 inch M1 LATE 2020 256GB vừa được trình làng tạo ấn tượng mạnh với con chip M1 tặng hi ',
            ...
            DB::table('products')->insert([
                [
                    ...
                    'product_type' => 'new',
                    'seo_title' => 'SEO tile',
                    'promotion' => 'Hỗ trợ trả góp 0% chỉ cần CCCD gắn chip hoặc 0% qua thẻ tín dụng',
                    'seo_description' => 'SEO des',
                    'category_id' => 3,
                    'weight' => 0.8,
                    'sub_category_id' => 28,
